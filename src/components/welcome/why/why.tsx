      ...
      <section className="w-[70%] m-auto text-center ">
        ...
        <section className="w-[100%] h-[80%] grid grid-cols-3 gap-10 my-[10vh] ">
          <section>
            ...
            <p className="text-xl  text-gray-700">Easy to Order</p>
            <p>
          ...
          <section>
            ...
            <p className="text-xl  text-gray-700">Best Pricing and Discounts</p>
            <p>
          ...
          <section>
            ...
            <p className="text-xl  text-gray-700">Fastest Delivery</p>
            <p>
